...
## Javascript Assignments  [![Build Status](https://travis-ci.org/Happy-Love/js-assignments.svg?branch=master)](https://travis-ci.org/Happy-Love/js-assignments)
...
* Edit local README.md file and update all links (just replace all occurrences of `'Happy-Love' or 'rolling-scopes-school'` with your account name).
